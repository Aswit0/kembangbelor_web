  ...
  <footer class="container-fluid py-4 footer-container">
    <div class="container text-center">
        <ul class="nav justify-content-center">
            ...
            <li class="nav-item"><a class="nav-link text-white" href="/">Wisata</a></li>
            <li class="nav-item"><a class="nav-link text-white" href="/kritik">Kritik Saran</a></li>
            <li class="nav-item"><a class="nav-link text-white" href="/360">360</a></li>
        </ul>
        <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item"><a href="#" class="text-muted" title="Tiktok"><i class="bi bi-tiktok"></i></a></li>
        </ul>
        <hr class="my-4">
